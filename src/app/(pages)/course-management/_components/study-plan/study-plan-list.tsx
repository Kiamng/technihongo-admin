            ...
            {defaultStudyPlan && (
                <>
                    ...
                    <div className="default width w-1/2">
                        <StudyPlanCard defaultStudyPlanId={defaultStudyPlan.studyPlanId} fetchStudyPlan={fetchStudyPlan} plan={defaultStudyPlan} />
                    </div>
                </>
            )}
                ...
                <>
                    ...
                    <div className="w-full grid gap-6 grid-cols-3">
                        {otherStudyPlans.map(plan => (
                            <StudyPlanCard defaultStudyPlanId={defaultStudyPlan?.studyPlanId as number} fetchStudyPlan={fetchStudyPlan} key={plan.studyPlanId} plan={plan} />
                        ))}
                    </div>
                </>
            )}
